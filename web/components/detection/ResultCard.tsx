...
export default function ResultCard({ result, modelId }: Props) {
  if (!result) {
    return (
      <div className="flex h-full min-h-[280px] flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 p-12 text-center dark:border-slate-800">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-100 dark:bg-slate-800">
          <BarChart3 className="h-6 w-6 text-slate-300 dark:text-slate-600" />
        </div>
        <p className="mt-4 font-medium text-slate-400 dark:text-slate-500">
  ...
  return (
    <div className="animate-fade-in space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:shadow-glow-sm">
      ...
      <p className="border-t border-slate-100 pt-3 text-xs leading-relaxed text-slate-400 dark:border-slate-800 dark:text-slate-500">
